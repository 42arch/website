...
const MenuWrapper: FunctionComponent<MenuWrapperProps> = ({ children }) => {
  return (
    <div className='w-8 h-8 my-1 bg-primary text-white rounded-full flex justify-center items-center hover:opacity-80'>
      {
        children
      }
    </div>
...
const SideMenu: FunctionComponent<IProps> = ({ isPost }) => {
