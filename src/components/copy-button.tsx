...
export function CopyButton({
  ...
  return (
    <button
      className={clsx(
        'absolute right-4 top-14 z-20 inline-flex h-8 items-center justify-center rounded-md border-none border-zinc-200 p-2 text-sm font-medium text-zinc-300 transition-all hover:bg-transparent hover:bg-zinc-800 hover:opacity-100 focus:outline-none',
        className
      )}
      onClick={() => {
