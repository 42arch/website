...
export const SiteFooter = () => {
  ...
  return (
    <footer className="text-center px-6 md:px-10 lg:px-16">
      <div className="flex flex-col items-center justify-between gap-0 text-sm leading-loose text-zinc-600 dark:text-zinc-400 border-t border-t-slate-200 py-10 dark:border-t-zinc-700 md:h-24 md:flex-row md:py-0">
