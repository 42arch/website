...
export default async function Page() {
  return (
    <>
      <City3D />
      <section className="select-none absolute pointer-events-none text-light w-full bg-transparent h-1/2 translate-y-1/2 z-10">
        ...
        <h4 className="text-sm text-center text-zinc-600 mt-4">
          -- This is ren dan's personal website, reach more from below. --
        </h4>
